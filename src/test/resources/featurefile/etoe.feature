...
#      | Gift Cards        | Gift Cards        | 3     |
  ...
  @live
  Scenario Outline: customer wants to change the currency
    Given user is on home page
    When he change the currency "<Currency>" into another currence
    Then he can be seen the changes in product prices
    Examples:
      | Currency  |
      | Euro      |
#      | US Dollar |
